...
func (r *authRepo) queryRowsWithFilter(ctx context.Context, query string, filter *models.UserFilter) (pgx.Rows, error) {
...
func (r *authRepo) SearchByFilter(ctx context.Context, filter *models.UserFilter, pq *utils.PaginationQuery) (*models.UserList, error) {
	ctx, cancel := context.WithTimeout(ctx, 5*time.Second)
	defer cancel()

	var totalCount int
	rowsC, err := r.queryRowsWithFilter(ctx, searchByFilterGetTotalCountQuery, &models.UserFilter{
